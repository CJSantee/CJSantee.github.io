...
// Assets
import Phone from '../assets/BrewablePhone.png';
    ...
    return (
        <Row className="section" id="Projects">
            <Col md className="order-md-last">
                ...
                <p className="text-secondary"><strong>Brewable</strong></p>
                ...
                <Button variant="outline-secondary" href="https://apps.apple.com/us/app/brewable/id1592801332" className="m-2">App Store</Button>
            </Col>
